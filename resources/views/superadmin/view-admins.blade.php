<!-- resources/views/superadmin/view-admins.blade.php -->
...
<x-app-layout>
    ...
    text-lg mb-4">User List</h3>

<!-- Admin Table -->
<h4 class="font-semibold text-md mb-2 mt-4">Admins</h4>
@include('superadmin.user-table', ['users' => $admins, 'role' => 'admin'])
</div>
</div>
</div>
</div>
