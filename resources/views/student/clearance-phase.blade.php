<!-- resources/views/student/clearance-phases/clearance-phases.blade.php -->
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="{{ route('student.dashboard') }}" class="block text-blue-500 hover:text-blue-700">
                {{ __('Student Dashboard') }}</a>Clearance Phases
        </h2>
    </x-slot>
    <div class="py-12">
                                    ...
                                    <div class="p-6 text-gray-900">
                                        ...
                                        @if ($errors->any())
                                            <div class="alert alert-danger" role="alert">
                                              ...
                                              @endif
<!-- Include the blades for different phases -->
@include('student.clearance-rules   ')
@includeIf('student.department', [
    'programmes' => $programmes,
])
@include('student.library')
@include('student.ict-center')
@include('student.guidance')
@include('student.student-affairs')
@include('student.bursary')
@include('student.records-unit')
</div>
</div>
</div>
</div>
