                ...
                <tr>
                    ...
                    <td>
                        @if ($departments->has($request->user_id))
                            <a
                                href="{{ route('staff.view-data', ['user_id' => $request->user_id, 'unit_id' => $request->unit_id]) }}">
                                View Data
                            </a>
                        @else
                            N/A
                    ...
                    <td>
                        <form method="POST" action="{{ route('staff.approve-clearance', $request->id) }}">
                            @csrf
                            <button type="submit" class="btn btn-success">Approve</button>
                        </form>
                    </td>
                    <td>
                        <a href="{{ route('staff.reject-clearance', $request->id) }}">Reject</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
